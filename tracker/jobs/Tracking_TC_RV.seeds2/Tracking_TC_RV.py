...
outfile         = f'TC_tracks.{experiment}.{run_ensemble:03d}.seeds2.nc'
...
def validate_seed(track):
    ...
    1) duration should be at least 21 hours
    2) after removing potential formation over land, the remaining duration should be at least 21 hours
    3) genesis location should be within [30S-30N]
    4) genesis SST should be >= 25C
